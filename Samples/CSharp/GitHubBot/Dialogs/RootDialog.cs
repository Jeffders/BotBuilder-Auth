...
namespace GitHubBot.Dialogs
{
    ...
    public class RootDialog : IDialog<object>
    {
        ...
        private async Task MessageReceivedAsync(IDialogContext context, IAwaitable<object> result)
        {
            ...
            {
                context.Call(new GetTokenDialog(), ListRepositories);
            }
            else if (message.ToLowerInvariant().Equals("notes"))
            {
                context.Call(new GetTokenDialog(), ListNotifications);
            }
            else if (message.ToLowerInvariant().Equals("who"))
            {
                context.Call(new GetTokenDialog(), ListUser);
            }
        ...
        private async Task ListRepositories(IDialogContext context, IAwaitable<string> tokenResponse)
        {
        ...
        private async Task ListNotifications(IDialogContext context, IAwaitable<string> tokenResponse)
        {
            var token = await tokenResponse;
        ...
        private async Task ListUser(IDialogContext context, IAwaitable<string> tokenResponse)
        {
            var token = await tokenResponse;
